...
test_df = pd.read_csv('test_data_ASPP.csv')
...
accuracy, precision, recall, f1, mse, all_original_images, all_species_maps, all_distance_maps, all_probability_maps, all_distance_maps_true, all_species_maps_true = amu.full_evaluation(model, test_loader, patch_size, stride, device)
print(f"Time taken for 50% overlap: {time.time() - start_time}")

amu.print_results_and_save(
